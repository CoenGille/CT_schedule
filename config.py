...
class Configuration():
    def __init__(self, *args, **kwargs):
        #--------------------SIM_SETTINGS------------------------
        self.verbose = True         #toggle to enable print to console for simulation events
        self.print_schedule = True #toggle wheter the sortie schedule is saved to xls after the run
        self.gen_first_schedule = True   #generate schedule at t=0 | False imports initial schedule from data folder
        ...
        #reschedule 
        # MR-WC - [31, 59, 90, 120, 151, 181, 212, 243, 273, 304, 337, 344, 351, 358]
        # SR-WC [120, 240, 304, 337, 344, 351, 358]
        # SR-MC [120, 240, 304, 334]
        # DR [120, 239, 246, 253, 260, 267, 274, 281, 288, 295, 302, 309, 316, 323, 330, 337, 344, 351, 358]
        self.rescheduling = [120, 240, 304, 337, 344, 351, 358]
        self.sortie_correct = 1.38   #overschedule rate osf
