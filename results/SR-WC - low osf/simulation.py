...
class Simulation():
    ...
    def run(self):
        ...
        for iteration in range(self.cf.iterations):
            ...
            with open(f'results/run_{iteration+1}_CTresults_live.txt', 'w', encoding='utf-8') as file:
                json.dump(sim.history.P_live, file, ensure_ascii=False, indent=2) 
            with open(f'results/run_{iteration+1}_CTresults_sim.txt', 'w', encoding='utf-8') as file:
                json.dump(sim.history.P_sim, file, ensure_ascii=False, indent=2) 
            with open(f'results/run_{iteration+1}_data.txt', 'w', encoding='utf-8') as file:
