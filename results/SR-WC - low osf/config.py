...
class Configuration():
    def __init__(self, *args, **kwargs):
        ...
        self.iterations = 29         #number of iterations in simulation 
        ...
        # KFI1 triaal HF close [120, 240, 304, 337, 344, 351, 358]
        ...
        self.sortie_correct = 1.28   #overschedule rate 
